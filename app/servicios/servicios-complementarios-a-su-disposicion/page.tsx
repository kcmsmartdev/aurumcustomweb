        ...
        <div className="w-full max-w-7xl mx-auto p-3 relative z-20 flex flex-col justify-center">
          <div className="w-full h-full flex flex-col justify-center mt-20">
            ...
            >
              ...
              &gt;
              <span>Servicios complementarios a su disposición</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-7xl mx-auto p-5 grid grid-cols-1 lg:grid-cols-2 gap-5 mt-32 py-16 bg-gris/5 rounded-4xl">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-gris text-16px ">
            Para ofrecerte una solución completa, coordinamos servicios
            complementarios clave para un mejor control dentro de los procesos
            logísticos.
          </p>

          <Image
            src="/images/imagen_servicio_3.webp"
            ...
            <ul className="border-l border-gris/30 pl-6 space-y-6 mt-5">
              <li className="relative">
                ...
                <span className="text-sm text-gris">
                 Distribución y recojo de carga desde y hacia el punto de llegada.
                </span>
              </li>

              <li className="relative">
                <span className="absolute -left-3 top-1 w-2 h-2 rounded-full bg-primario"></span>
                <p className="text-negro">Transporte internacional:</p>
                <span className="text-sm text-gris">
                Traslado de mercancías desde país de origen hasta país de destino.
                </span>
              </li>

              <li className="relative">
                <span className="absolute -left-3 top-1 w-2 h-2 rounded-full bg-primario"></span>
                <p className="text-negro">Almacenamiento:</p>
                <span className="text-sm text-gris">
                  Gestión de almacenaje simple y depósito aduanero
                </span>
              </li>

              <li className="relative">
                <span className="absolute -left-3 top-1 w-2 h-2 rounded-full bg-primario"></span>
                <p className="text-negro">Seguro de Carga:</p>
                <span className="text-sm text-gris">
                  Aseguramos tu mercancía contra todo riesgo
                </span>
              </li>
