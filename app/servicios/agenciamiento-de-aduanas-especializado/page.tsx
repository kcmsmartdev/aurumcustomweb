        ...
        <div className="w-full max-w-7xl mx-auto p-3 relative z-20 flex flex-col justify-center">
          <div className="w-full h-full flex flex-col justify-center mt-20">
            ...
            >
              ...
              &gt;
              <span>Agenciamiento de aduanas especializado</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-7xl mx-auto p-5 grid grid-cols-1 lg:grid-cols-2 gap-5 mt-32 bg-gris/5 rounded-4xl">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-gris text-16px ">
            Gestionamos integralmente todos los regímenes aduaneros según la{" "}
            <strong>Ley General de Aduanas (D.L. N° 1053)</strong>, garantizando
            cumplimiento normativo, reducción de riesgos y optimización de
            tiempos y costos en cada operación.
          </p>

          <Image
            src="/images/imagen_servicio_1.webp"
        ...
        <div className=" flex flex-col gap-4">
          <section>
            ...
            <ul className="border-l border-gris/30 pl-6 space-y-6 mt-5">
              ...
              <li className="relative">
                <span className="absolute -left-3 top-1 w-2 h-2 rounded-full bg-primario"></span>
                <p className="text-negro">Exportación Definitiva</p>
              </li>

              <li className="relative">
                <span className="absolute -left-3 top-1 w-2 h-2 rounded-full bg-primario"></span>
                <p className="text-negro">Regímenes Temporales</p>
                <span className="text-sm text-gris">
                  (Admisión e Exportación Temporal)
                </span>
              </li>

              <li className="relative">
                <span className="absolute -left-3 top-1 w-2 h-2 rounded-full bg-primario"></span>
                <p className="text-negro">Regímenes de Perfeccionamiento</p>
                <span className="text-sm text-gris">
                  (Drawback, Admisión Temporal para Perfeccionamiento Activo)
                </span>
              </li>

              <li className="relative">
                <span className="absolute -left-3 top-1 w-2 h-2 rounded-full bg-primario"></span>
                <p className="text-negro">Depósito Aduanero</p>
              </li>

              <li className="relative">
                <span className="absolute -left-3 top-1 w-2 h-2 rounded-full bg-primario"></span>
                <p className="text-negro">
                  Tránsitos, Transbordos y Reembarques
                </p>
              </li>
            </ul>
          </section>
